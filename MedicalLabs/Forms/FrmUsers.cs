    ...
    public partial class FrmUsers : Form
    {
        ...
        private void FrmUsers_Load(object sender, EventArgs e)
        {
           FunctionsClass.userTrafficRegister(this.Name, true);
            ...
            cmbEmployee.DataSource = dsUsers.Tables[3];
        ...
        void getData()
        {
            ...
            //                           "SELECT Id,[Name] FROM TblEmployees WHERE Del=0 ORDER BY [Name]";
            ...
            SQLConClass.sqlQuery = "SELECT * FROM TblUser " +
                                    "SELECT * FROM TblOperations " +
                                    "SELECT * FROM TblPermissions " +
                                    "SELECT Id,[Name] FROM TblEmployees WHERE Del=0 ORDER BY [Name]";
            dsUsers = sql.selectData(SQLConClass.sqlQuery,0, null);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (btnDelete.Text == "حذف")
            {
                ...
                SQLConClass sql = new SQLConClass();
                SqlParameter[] param = new SqlParameter[] { new SqlParameter("@Id", currentUserID) };
                sql.cmdExecute("UserDelete", 1, param);
            ...
            {
                SQLConClass sql = new SQLConClass();
                SQLConClass.sqlQuery = "UPDATE TblUser SET Del='FALSE' WHERE Id=" + currentUserID;
                sql.cmdExecute(SQLConClass.sqlQuery,0,null);
